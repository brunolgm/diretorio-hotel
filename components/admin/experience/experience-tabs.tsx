...
import { Eye, LayoutDashboard, Palette } from 'lucide-react';
import { cn } from '@/lib/utils';

export const EXPERIENCE_TABS = [
  { key: 'composicao', label: 'Composição', icon: LayoutDashboard, available: true },
  { key: 'aparencia', label: 'Aparência', icon: Palette, available: true },
  { key: 'preview', label: 'Pré-visualização', icon: Eye, available: true },
] as const;

export function ExperienceTabs({ activeTab, previewEnabled }: { activeTab: string; previewEnabled: boolean }) {
  return (
