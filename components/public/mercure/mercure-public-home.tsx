...
export function MercurePublicHome({ pageData, language, domainContext, preferSubdomainRoot }: {
  ...
  const flightCard = flightHomeCard ? <PublicFlightHomeCard card={flightHomeCard} hotelSlug={hotel.slug} language={language} domainContext={domainContext} preferSubdomainRoot={preferSubdomainRoot} variant="mercure" /> : null;
