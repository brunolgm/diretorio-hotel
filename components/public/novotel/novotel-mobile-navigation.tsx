...
export function NovotelMobileNavigation({
  ...
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-30 border-t border-slate-100 bg-white/96 pb-[env(safe-area-inset-bottom)] shadow-[0_-14px_34px_-26px_rgba(15,23,42,0.35)] backdrop-blur-xl md:hidden"
    >
