...
export function getPublicFlightCenterCopy(language: SupportedPublicLanguage) {
  if (language === 'en') return {
    ...
    tripActionsTitle: 'Travel actions', addToCalendar: 'Add to calendar', calendarDownloaded: 'Calendar downloaded', openAirportRoute: 'Open route to the airport', calendarFlightLabel: 'Flight', calendarInformedTime: 'Time provided by the guest.', checkAvailability: 'Check availability',
  ...
  if (language === 'es') return {
    ...
    tripActionsTitle: 'Acciones del viaje', addToCalendar: 'Añadir al calendario', calendarDownloaded: 'Calendario descargado', openAirportRoute: 'Abrir ruta al aeropuerto', calendarFlightLabel: 'Vuelo', calendarInformedTime: 'Horario informado por el huésped.', checkAvailability: 'Consultar disponibilidad',
  ...
  return {
    ...
    tripActionsTitle: 'Ações da viagem', addToCalendar: 'Adicionar ao calendário', calendarDownloaded: 'Calendário baixado', openAirportRoute: 'Abrir rota para o aeroporto', calendarFlightLabel: 'Voo', calendarInformedTime: 'Horário informado pelo hóspede.', checkAvailability: 'Consultar disponibilidade',
